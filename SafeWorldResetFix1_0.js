...
// --- SafeWorldResetFix: nodeArray readiness guard ---
const nodeArray = aiNodes.nodeArray;

// 1️⃣ Úplne legitímny stav počas world switch / init
if (nodeArray == null) {
    setTimeout(checkReady, 10);
    return;
}

// 2️⃣ Neplatný typ = skutočný problém (ten chceme vidieť)
if (!Array.isArray(nodeArray)) {
    console.warn('[SafeWorldResetFix] nodeArray invalid type:', nodeArray);
    resolve(false);
    return;
}

// 3️⃣ Prázdne pole je OK – rieši sa nižšie
