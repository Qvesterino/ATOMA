...
import { NodeHarmonicManager } from './harmony/HarmonicHubSync.js';
...
export class LinkRendererConduit {
    ...
    getLinkRuntimeReport(linkId = null) {
        ...
        const statuses = {
            flowModulation: (this.modules.flow && (runtime.flowModulationTicks || 0) > 0)
        ...
        return {
            ...
            resources: {
                ...
                hasFlowModulation: this.modules.flow && Array.isArray(state.strands) && state.strands.length > 0,
