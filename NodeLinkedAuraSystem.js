...
const DEFAULT_LINKED_AURA_HARMONY_BANDS = Object.freeze({
  low: Object.freeze({
    max: 0.35,
    opacity: bandRange(0.70, 0.84),
    desaturation: bandRange(0.78, 0.62)
  }),
  mid: Object.freeze({
    max: 0.65,
    opacity: bandRange(0.90, 1.06),
    desaturation: bandRange(0.46, 0.30)
  }),
  high: Object.freeze({
    max: 1.0,
    opacity: bandRange(1.10, 1.28),
    desaturation: bandRange(0.18, 0.06)
  })
});
