...
const DEFAULT_LINKED_AURA_HARMONY_BANDS = Object.freeze({
...
function resolveLinkedAuraHarmonyValue(node) {
...
function resolveLinkedAuraHarmonyBand(harmony, bands = DEFAULT_LINKED_AURA_HARMONY_BANDS) {
  ...
  if (value <= bands.low.max) {
    ...
    return { name: 'low', opacityMultiplier: opacityRange.min + (opacityRange.max - opacityRange.min) * t, desaturation: desaturationRange.min + (desaturationRange.max - desaturationRange.min) * t };
  }
  if (value <= bands.mid.max) {
    ...
    return { name: 'mid', opacityMultiplier: opacityRange.min + (opacityRange.max - opacityRange.min) * t, desaturation: desaturationRange.min + (desaturationRange.max - desaturationRange.min) * t };
  }
  ...
  return { name: 'high', opacityMultiplier: opacityRange.min + (opacityRange.max - opacityRange.min) * t, desaturation: desaturationRange.min + (desaturationRange.max - desaturationRange.min) * t };
}
