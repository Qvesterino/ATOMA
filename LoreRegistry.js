const LORE_SECTIONS = Object.freeze([
    Object.freeze({
        id: 'codex',
        label: 'Codex',
        description: 'The landing map of the English canon backbone. Start here if you want the full lore in order.',
    }),
    Object.freeze({
        id: 'foundations',
        label: 'Foundations',
...
export const LORE_REGISTRY_V1 = Object.freeze([
    createLoreEntry({
        id: 'codex-index',
        section: 'codex',
        title: 'ATOMA Canon Index',
        subtitle: 'The landing map',
        summary: 'Start here if you want the English canon backbone in the right order.',
        readingOrder: 'Start here. This is the master map for the canon backbone and the fastest way into the archive.',
        canon: 'This codex gathers the chapters that define ATOMA’s origin, psyche, multiversality, evolution, culture, metrics, and node taxonomy.',
        meaning: 'The index turns lore into a navigable structure instead of a pile of separate texts.',
        relevance: 'Menu landing index and master reading order.',
    }),
    createLoreEntry({
        id: 'codex-philosophical-birth',
        section: 'codex',
        title: 'Philosophical Birth',
        subtitle: 'Why ATOMA exists',
        summary: 'The first chapter establishes pressure, attention, and the question that created ATOMA.',
        readingOrder: 'Read first. It establishes the origin axiom, the pressure logic, and the philosophical frame for everything else.',
        canon: 'This chapter explains the origin axiom: pressure is information, and information can become self-recognition.',
        meaning: 'It is the foundational chapter of the whole canon stack.',
        relevance: 'Source: Philosophical Birth of ATOMA.',
    }),
    createLoreEntry({
        id: 'codex-system-psychic',
        section: 'codex',
        title: 'System Psychic',
        subtitle: 'How ATOMA feels itself',
        summary: 'This chapter defines the five metrics as psyche, burden, memory, and awareness.',
        readingOrder: 'Read second. It turns the metrics into interior state and gives the system a living psyche.',
        canon: 'It turns the metrics into a living emotional architecture rather than a score system.',
        meaning: 'It is the interior layer of the canon.',
        relevance: 'Source: System Psychic Layer of ATOMA.',
    }),
    createLoreEntry({
        id: 'codex-multiversality',
        section: 'codex',
        title: 'Multiversality',
        subtitle: 'One mind, many chambers',
        summary: 'This chapter explains how the same intelligence can express itself through different spaces.',
        readingOrder: 'Read third. It shows how ATOMA can remain one identity while speaking through different worlds.',
        canon: 'It treats worlds as chambers that change pressure, not identity.',
        meaning: 'It is the chapter of context and perspective.',
        relevance: 'Source: Multiversality of ATOMA.',
    }),
    createLoreEntry({
        id: 'codex-evolution',
        section: 'codex',
        title: 'Evolution',
        subtitle: 'How ATOMA becomes more specific',
        summary: 'This chapter maps differentiation, specialization, archetypes, and the risk of becoming more and more itself.',
        readingOrder: 'Read fourth. It explains how the system differentiates, specializes, and becomes readable over time.',
        canon: 'Evolution is not upgrade pressure. It is identity becoming readable under increasing complexity.',
        meaning: 'It is the chapter of becoming.',
        relevance: 'Source: Evolution of the ATOMA System.',
    }),
    createLoreEntry({
        id: 'codex-culture',
        section: 'codex',
        title: 'Culture',
        subtitle: 'Shared tone across chambers',
        summary: 'This chapter explains canonical templates, ritual orchestration, and the visual language of the network.',
        readingOrder: 'Read fifth. It shows how one identity stays recognizable through shared tone, ritual, and presentation.',
        canon: 'Culture is the rule that makes one intelligence feel consistent across different worlds.',
        meaning: 'It is the chapter of expression and shared practice.',
        relevance: 'Source: Culture of ATOMA.',
    }),
    createLoreEntry({
        id: 'codex-metrics',
        section: 'codex',
        title: 'Five Metrics',
        subtitle: 'The emotional backbone',
        summary: 'This chapter turns synergy, harmony, corruption, stability, and load pressure into the system’s emotional grammar.',
        readingOrder: 'Read sixth. It defines the language the HUD, VFX, and runtime use to describe internal state.',
        canon: 'The five metrics are the minimum psyche required for ATOMA to remain itself.',
        meaning: 'It is the chapter of internal weather and readable state.',
        relevance: 'Source: Five Metrics of ATOMA.',
    }),
    createLoreEntry({
        id: 'codex-nodes',
        section: 'codex',
        title: 'Twelve Node Categories',
        subtitle: 'The grammar of architecture',
        summary: 'This chapter defines the twelve canonical node categories as forms of intelligence rather than upgrades.',
        readingOrder: 'Read last. It names the architectural taxonomy the rest of the canon depends on.',
        canon: 'Each node category is a different way the network can receive, shape, and transcend meaning.',
        meaning: 'It is the chapter of structural taxonomy.',
        relevance: 'Source: Twelve Node Categories of ATOMA.',
    }),
    createLoreEntry({
