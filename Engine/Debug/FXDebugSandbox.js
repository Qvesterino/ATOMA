...
class FXDebugSandbox {
  ...
  /**
   * Static method to check if a system is enabled in the FXDebugSandbox
   * Can be called from any system to check if it should run
   */
  static isEnabled(systemName) {
    // Try to get the global FX instance
  ...
  _buildManualNodeFxRegistry() {
    return [
      ...
      // Glyph & Orbit Systems
      { id: 'glyphLayer4', label: 'Glyph Layer 4 - MultiFusion', group: 'Glyph / Orbit', paths: ['glyphLayer4'], muteMethods: ['update', 'enable', 'disable', 'cleanup'] },
      { id: 'atomaGlyphSystem4', label: 'Atoma Glyph System 4.0', group: 'Glyph / Orbit', paths: ['glyphSystem4', 'atomaGlyphSystem4'], muteMethods: ['update', 'cleanup'] },
      { id: 'proceduralMeaningEngine', label: 'Procedural Meaning Engine', group: 'Glyph / Orbit', paths: ['proceduralMeaningEngine', 'proceduralGlyphGenerator'], muteMethods: ['update', 'cleanup'] },
      { id: 'compositeGlyphGenerator', label: 'Composite Glyph Generator', group: 'Glyph / Orbit', paths: ['compositeGlyphGenerator'], muteMethods: ['update'] },
      { id: 'glyphFusionZoneManager', label: 'Glyph Fusion Zone', group: 'Glyph / Orbit', paths: ['glyphFusionZoneManager', 'glyphFusionZone'], muteMethods: ['update'] },
      { id: 'glyphAnimationModulator', label: 'Glyph Animation Modulator', group: 'Glyph / Orbit', paths: ['glyphAnimationModulator'], muteMethods: ['update'] },
      { id: 'adaptiveGlyphRendering', label: 'Adaptive Glyph Rendering', group: 'Glyph / Orbit', paths: ['adaptiveGlyphRendering'], muteMethods: ['update', 'setEnabled'] },
      { id: 'semanticGlyphAI', label: 'Semantic Glyph AI', group: 'Glyph / Orbit', paths: ['semanticGlyphAI'], muteMethods: ['update'] },
      { id: 'recursiveGlyphSignalSystem', label: 'Recursive Glyph Signal', group: 'Glyph / Orbit', paths: ['recursiveGlyphSignalSystem'], muteMethods: ['update'] },
      { id: 'aiConsciousnessLayer', label: 'AI Consciousness Layer', group: 'AI / Orbit', paths: ['consciousnessLayer', 'aiConsciousnessLayer'], muteMethods: ['update'] },
      { id: 'linkSemanticPictogramSystem', label: 'Link Semantic Pictogram', group: 'Glyph / Orbit', paths: ['linkSemanticPictogramSystem'], muteMethods: ['update'] },
      // Visual FX Systems
      { id: 'corruptionVisualFX', label: 'Corruption Visual FX', group: 'Visual FX', paths: ['corruptionVisualFX'], muteMethods: ['update'] },
      { id: 'colonyVFXManager', label: 'Colony VFX Manager', group: 'Visual FX', paths: ['colonyVFXManager', 'colonyVfxManager'], muteMethods: ['update', 'setEnabled', 'enable', 'disable'] },
      { id: 'nodeAuraSystem', label: 'Node Aura System', group: 'Visual FX', paths: ['nodeAuraSystem'], muteMethods: ['update'] },
      { id: 'nodeAuraRenderer', label: 'Node Aura Renderer', group: 'Visual FX', paths: ['nodeAuraRenderer'], muteMethods: ['update'] },
      { id: 'legendaryLinkFX', label: 'Legendary Link FX', group: 'Visual FX', paths: ['legendaryLinkFX'], muteMethods: ['update'] },
      { id: 'linkEnergyRingSystem', label: 'Link Energy Ring', group: 'Visual FX', paths: ['linkEnergyRingSystem'], muteMethods: ['update'] },
      { id: 'stressVisualShaderSystem', label: 'Stress Visual Shader', group: 'Visual FX', paths: ['stressVisualShaderSystem'], muteMethods: ['update'] },
      { id: 'canonicalStressVisuals', label: 'Canonical Stress Visuals', group: 'Visual FX', paths: ['canonicalTemplate3StressVisuals', 'canonicalStressVisuals', 'stressVisuals', 'canonicalTemplateStressVisuals'], muteMethods: ['update', 'setEnabled', 'enable', 'disable'] },
      { id: 'metricsVisualFX', label: 'Metrics Visual FX', group: 'Visual FX', paths: ['metricsVisualFX'], muteMethods: ['update'] },
      { id: 'nodeInspectOverlay', label: 'Node Inspect Overlay', group: 'Visual FX', paths: ['nodeInspectOverlay'], muteMethods: ['update', 'enable', 'disable', 'hideOverlay', 'showOverlay'] },
      { id: 'visualNetworkTimeElasticity', label: 'Visual Network Time Elasticity', group: 'Visual FX', paths: ['visualNetworkTimeElasticity'], muteMethods: ['update'] },
      { id: 'nodeShaderActivation', label: 'Node Shader Activation', group: 'Visual FX', paths: ['nodeShaderActivation'], muteMethods: ['update'] },
      { id: 'glyphFusionOverlay', label: 'Glyph Fusion Overlay', group: 'Visual FX', paths: ['glyphFusionOverlay'], muteMethods: ['update'] },
      { id: 'visualStateBinder', label: 'Visual State Binder', group: 'Visual FX', paths: ['visualStateBinder', 'nodeVisualStateBinder'], muteMethods: ['update', 'bindNode', 'unbindNode'] },
      { id: 'visualAutoWiringSystem', label: 'Visual Auto Wiring', group: 'Visual FX', paths: ['visualAutoWiringSystem'], muteMethods: ['update'] },
      { id: 'visualOverlayAuditSystem', label: 'Visual Overlay Audit', group: 'Visual FX', paths: ['visualOverlayAuditSystem'], muteMethods: ['update'] },
      { id: 'selectedRingSystem', label: 'Selected Ring System', group: 'Visual FX', paths: ['selectedRingSystem'], muteMethods: ['update'] },
      { id: 'coreVisualAuthoritySystem', label: 'Core Visual Authority', group: 'Visual FX', paths: ['coreVisualAuthoritySystem'], muteMethods: ['update'] },
      { id: 'fresnelRimLightController', label: 'Fresnel Rim Light', group: 'Visual FX', paths: ['fresnelRimLightController'], muteMethods: ['update'] },
      { id: 'dreamDepthEffectManager', label: 'Dream Depth Effects', group: 'Environment', paths: ['dreamDepthEffectManager'], muteMethods: ['update'] },
      { id: 'ambientEntityManager', label: 'Ambient Entity Manager', group: 'Environment', paths: ['ambientEntityManager'], muteMethods: ['update'] },
      { id: 'environmentDomainController', label: 'Environment Domain', group: 'Environment', paths: ['environmentDomainController'], muteMethods: ['update'] },
      { id: 'systemStateOverlay', label: 'System State Overlay', group: 'Environment', paths: ['systemStateOverlay'], muteMethods: ['update'] },
      { id: 'distanceLODController', label: 'Distance LOD Controller', group: 'Environment', paths: ['distanceLODController'], muteMethods: ['update'] },
      // Particle & Effect Systems
      { id: 'cascadeParticleSystem', label: 'Cascade Particle System', group: 'Particles', paths: ['cascadeParticleSystem'], muteMethods: ['update'] },
      { id: 'healingParticleSystem', label: 'Healing Particles', group: 'Particles', paths: ['healingParticleSystem'], muteMethods: ['update'] },
      { id: 'linkHealingParticleSystem', label: 'Link Healing Particles', group: 'Particles', paths: ['linkHealingParticleSystem'], muteMethods: ['update'] },
      { id: 'linkCorruptionParticleSystem', label: 'Link Corruption Particles', group: 'Particles', paths: ['linkCorruptionParticleSystem'], muteMethods: ['update'] },
      { id: 'linkTrailParticles', label: 'Link Trail Particles', group: 'Particles', paths: ['linkTrailParticles'], muteMethods: ['update'] },
      { id: 'linkBeadTrailSystem', label: 'Link Bead Trail', group: 'Particles', paths: ['linkBeadTrailSystem'], muteMethods: ['update'] },
      { id: 'linkSparkSystem', label: 'Link Spark System', group: 'Particles', paths: ['linkSparkSystem'], muteMethods: ['update'] },
      { id: 'linkBeadSystem', label: 'Link Bead System', group: 'Particles', paths: ['linkBeadSystem'], muteMethods: ['update'] },
      { id: 'waveParticleEmitter', label: 'Wave Particle Emitter', group: 'Particles', paths: ['particleEmitter', 'waveParticleEmitter'], muteMethods: ['update'] },
      { id: 'resonanceEchoTrailSystem', label: 'Resonance Echo Trails', group: 'Particles', paths: ['resonanceEchoTrailSystem', 'resonanceEchoTrails'], muteMethods: ['update'] },
      // Link FX Systems
      { id: 'linkRendererConduit', label: 'Link Renderer Conduit', group: 'Link FX', paths: ['linkRendererConduit'], muteMethods: ['update'] },
      { id: 'linkCascadeInfectionSystem', label: 'Link Cascade Infection', group: 'Link FX', paths: ['linkCascadeInfectionSystem'], muteMethods: ['update'] },
      { id: 'linkCascadePulseManager', label: 'Link Cascade Pulse', group: 'Link FX', paths: ['linkCascadePulseManager'], muteMethods: ['update'] },
      { id: 'linkCollapseSystem', label: 'Link Collapse System', group: 'Link FX', paths: ['linkCollapseSystem'], muteMethods: ['update'] },
      { id: 'linkCollapseEventFX', label: 'Link Collapse FX', group: 'Link FX', paths: ['linkCollapseEventFX'], muteMethods: ['update'] },
      { id: 'linkDegradationSystem', label: 'Link Degradation', group: 'Link FX', paths: ['linkDegradationSystem'], muteMethods: ['update'] },
      { id: 'linkPriorityDecayEngine', label: 'Link Priority Decay', group: 'Link FX', paths: ['linkPriorityDecayEngine'], muteMethods: ['update'] },
      { id: 'linkPrioritySystem', label: 'Link Priority System', group: 'Link FX', paths: ['linkPrioritySystem'], muteMethods: ['update'] },
      { id: 'linkCorrelationEngine', label: 'Link Correlation Engine', group: 'Link FX', paths: ['linkCorrelationEngine1_0'], muteMethods: ['update'] },
      { id: 'linkQualityCalculator', label: 'Link Quality Calculator', group: 'Link FX', paths: ['linkQualityCalculator'], muteMethods: ['update'] },
      { id: 'linkStateVisualLanguage', label: 'Link State Visual Language', group: 'Link FX', paths: ['linkStateVisualLanguage'], muteMethods: ['update'] },
      { id: 'linkVisualMoodSystem', label: 'Link Visual Mood', group: 'Link FX', paths: ['linkVisualMoodSystem'], muteMethods: ['update'] },
      { id: 'linkAutomationEngine', label: 'Link Automation Engine', group: 'Link FX', paths: ['linkAutomationEngine1_0'], muteMethods: ['update'] },
      // Resonance Systems
      ...
      { id: 'regionalHarmonicCycleController', label: 'Regional Harmonic Cycle', group: 'Resonance', paths: ['regionalHarmonicCycleController'], muteMethods: ['update'] },
      { id: 'nodeHarmonicManager', label: 'Node Harmonic Manager', group: 'Resonance', paths: ['nodeHarmonicManager'], muteMethods: ['update'] },
      { id: 'harmonicSyncEffectApplier', label: 'Harmonic Sync Effect', group: 'Resonance', paths: ['harmonicSyncEffectApplier', 'harmonicSyncEffect'], muteMethods: ['update'] },
      // Cascade Systems
      { id: 'cascadeVisualizer', label: 'Cascade Visualizer', group: 'Cascade', paths: ['cascadeVisualizer', 'synergyCascadeVisualizer'], muteMethods: ['update', 'triggerCascade'] },
      { id: 'cascadeResonanceWave', label: 'Cascade Resonance Wave', group: 'Cascade', paths: ['cascadeResonanceWave', 'cascadeResonanceWaveVisualization'], muteMethods: ['update'] },
      { id: 'resonanceCascadeVisualization', label: 'Resonance Cascade Visualization', group: 'Cascade', paths: ['resonanceCascadeVisualization', 'resonanceCascade'], muteMethods: ['update'] },
      ...
      { id: 'criticalNodeFailure', label: 'Critical Node Failure', group: 'Cascade', paths: ['criticalNodeFailure', 'criticalNodeFailureSystem'], muteMethods: ['update'] },
      { id: 'corruptionFeedback', label: 'Corruption Feedback', group: 'Cascade', paths: ['corruptionFeedback'], muteMethods: ['update', 'displayCorruptionSeed', 'displayCascadeWarning', 'displayHarmonyPulse'] },
      { id: 't2CorruptionVisualIntegration', label: 'T2 Corruption Visual Integration', group: 'Cascade', paths: ['t2CorruptionVisualIntegration'], muteMethods: ['update', 'triggerCorruptionPulse', 'triggerParticleBurst', 'displayCascadeWarning', 'displayCorruptionSeed'] },
      // Healing & Rupture Systems
      { id: 'resonanceRuptureVisualSystem', label: 'Resonance Rupture Visual', group: 'Healing / Rupture', paths: ['resonanceRuptureVisualSystem', 'resonanceRupture'], muteMethods: ['update', '_triggerRupture', '_triggerNodeReactions'] },
      { id: 'healingParticles', label: 'Healing Particles', group: 'Healing / Rupture', paths: ['healingParticles'], muteMethods: ['update', 'spawnParticle', 'emitHealingTrail', 'emitHealingBurst'] },
      ...
      { id: 'waveTravelShaderPack', label: 'Wave Travel Shader Pack', group: 'Waves / Resonance', paths: ['waveTravelShaderPack'], muteMethods: ['update'] },
      { id: 'waveDynamicsShaderPack', label: 'Wave Dynamics Shader Pack', group: 'Waves / Resonance', paths: ['waveDynamicsShaderPack'], muteMethods: ['update', 'applyToNode', 'applyToMaterial'] },
      { id: 'echoRippleSystem', label: 'Echo Ripple System', group: 'Waves / Resonance', paths: ['echoRippleSystem'], muteMethods: ['update'] },
      // Node Core Systems
      ...
      { id: 'personalityShaderEffects', label: 'Personality Shader Effects', group: 'Node Core', paths: ['personalityShaderEffects'], muteMethods: ['update', 'registerNodeMaterial', 'registerLinkMaterial', 'applyDefaultNodeProfile', 'applyDefaultLinkProfile'] },
      { id: 'advancedShaderFX', label: 'Advanced Node Shader FX', group: 'Node Core', paths: ['advancedShaderFX'], muteMethods: ['update', 'setEnabled'] },
      { id: 'personalityFX', label: 'Safe Node Personality FX', group: 'Node Core', paths: ['personalityFX'], muteMethods: ['update'] },
      { id: 'safeEvolutionManager', label: 'Safe Evolution Manager', group: 'Node Core', paths: ['evolutionManager'], muteMethods: ['update'] },
      { id: 'visualStateBinder', label: 'Visual State Binder', group: 'Node Core', paths: ['visualStateBinder', 'nodeVisualStateBinder'], muteMethods: ['update', 'bindNode', 'unbindNode'] },
      ...
      { id: 'networkFatigueSystem', label: 'Network Fatigue System', group: 'Node Core', paths: ['networkFatigueSystem'], muteMethods: ['update'] },
      { id: 'influenceAttenuationAbsorptionSystem', label: 'Influence Attenuation System', group: 'Node Core', paths: ['influenceAttenuationAbsorptionSystem'], muteMethods: ['update'] },
      { id: 'influenceReflectionBackPressureSystem', label: 'Influence Reflection System', group: 'Node Core', paths: ['influenceReflectionBackPressureSystem'], muteMethods: ['update'] },
      { id: 'visualHierarchyCorrectionSystem', label: 'Visual Hierarchy Correction', group: 'Node Core', paths: ['visualHierarchyCorrectionSystem_v1'], muteMethods: ['update'] },
      { id: 'coreVisualAuthoritySystem', label: 'Core Visual Authority', group: 'Node Core', paths: ['coreVisualAuthoritySystem'], muteMethods: ['update'] },
      // World & Environment
      { id: 'worldPersonalityController', label: 'World Personality Controller', group: 'Environment', paths: ['worldPersonalityController'], muteMethods: ['update'] },
      { id: 'environmentDomainController', label: 'Environment Domain Controller', group: 'Environment', paths: ['environmentDomainController'], muteMethods: ['update'] },
      { id: 'ambientEntityManager', label: 'Ambient Entity Manager', group: 'Environment', paths: ['ambientEntityManager'], muteMethods: ['update'] },
      { id: 'colonyVFXManager', label: 'Colony VFX Manager', group: 'Environment', paths: ['colonyVFXManager', 'colonyVfxManager'], muteMethods: ['update', 'setEnabled', 'enable', 'disable'] },
      { id: 'mythicRitualController', label: 'Mythic Ritual Controller', group: 'Environment', paths: ['mythicRitualController'], muteMethods: ['update'] },
      { id: 'eventDramaturgyEngine', label: 'Event Dramaturgy Engine', group: 'Environment', paths: ['eventDramaturgyEngine'], muteMethods: ['update'] },
      { id: 'loreUnlockEngine', label: 'Lore Unlock Engine', group: 'Environment', paths: ['loreUnlockEngine'], muteMethods: ['update'] },
      { id: 'sessionVariantEngine', label: 'Session Variant Engine', group: 'Environment', paths: ['sessionVariantEngine'], muteMethods: ['update'] },
      { id: 'systemStateOverlay', label: 'System State Overlay', group: 'Environment', paths: ['systemStateOverlay'], muteMethods: ['update'] },
      { id: 'visualAutoWiringSystem', label: 'Visual Auto Wiring', group: 'Environment', paths: ['visualAutoWiringSystem'], muteMethods: ['update'] },
      { id: 'visualOverlayAuditSystem', label: 'Visual Overlay Audit', group: 'Environment', paths: ['visualOverlayAuditSystem'], muteMethods: ['update'] },
      { id: 'distanceLODController', label: 'Distance LOD Controller', group: 'Environment', paths: ['distanceLODController'], muteMethods: ['update'] },
      { id: 'stressTurbulenceController', label: 'Stress Turbulence Controller', group: 'Environment', paths: ['stressTurbulenceController'], muteMethods: ['update'] },
      { id: 'stressTurbulenceControllerBatch', label: 'Stress Turbulence Batch', group: 'Environment', paths: ['stressTurbulenceControllerBatch'], muteMethods: ['update'] },
      { id: 'temporalUnitSystem', label: 'Temporal Unit System', group: 'Environment', paths: ['temporalUnitSystem'], muteMethods: ['update'] },
      { id: 'frameScheduler', label: 'Frame Scheduler', group: 'Environment', paths: ['frameScheduler'], muteMethods: ['update'] },
      { id: 'visualTime', label: 'Visual Time', group: 'Environment', paths: ['visualTime'], muteMethods: ['update'] },
      { id: 'atomaAudioSystem', label: 'Atoma Audio System', group: 'Environment', paths: ['atomaAudioSystem'], muteMethods: ['update'] },
      { id: 'atomaBootController', label: 'Atoma Boot Controller', group: 'Environment', paths: ['atomaBootController'], muteMethods: ['update'] },
      { id: 'systemRegistry', label: 'System Registry', group: 'Environment', paths: ['systemRegistry'], muteMethods: ['update'] },
      { id: 'fxPerformanceController', label: 'FX Performance Controller', group: 'Environment', paths: ['fxPerformanceController', 'fxPerformance'], muteMethods: ['update'] },
      { id: 'visualUpgradeSuperpack', label: 'Visual Upgrade Superpack', group: 'Environment', paths: ['visualUpgradeSuperpack'], muteMethods: ['update'] },
      { id: 'cinematicUpgrade', label: 'Cinematic Upgrade', group: 'Environment', paths: ['cinematicUpgrade'], muteMethods: ['update'] },
      { id: 'dreamDesert', label: 'Dream Desert', group: 'Environment', paths: ['dreamDesert'], muteMethods: ['update'] },
      { id: 'dreamDesert2', label: 'Dream Desert 2', group: 'Environment', paths: ['dreamDesert2'], muteMethods: ['update'] },
      { id: 'fractalValley', label: 'Fractal Valley', group: 'Environment', paths: ['fractalValley'], muteMethods: ['update'] },
      { id: 'quantumIsland', label: 'Quantum Island', group: 'Environment', paths: ['quantumIsland'], muteMethods: ['update'] },
      { id: 'cognitiveHorizonPlane', label: 'Cognitive Horizon Plane', group: 'Environment', paths: ['cognitiveHorizonPlane'], muteMethods: ['update'] },
      { id: 'canonicalGeometryFamilies', label: 'Canonical Geometry Families', group: 'Environment', paths: ['canonicalGeometryFamilies'], muteMethods: ['update'] },
      { id: 'archetypeShaderModes', label: 'Archetype Shader Modes', group: 'Environment', paths: ['archetypeShaderModes'], muteMethods: ['update'] },
      { id: 'adaptivePerformanceMonitor', label: 'Adaptive Performance Monitor', group: 'Environment', paths: ['adaptivePerformanceMonitor'], muteMethods: ['update'] },
      { id: 'frameUpdateLoopOrderValidator', label: 'Frame Update Validator', group: 'Environment', paths: ['frameUpdateLoopOrderValidator'], muteMethods: ['update'] },
      { id: 'fxDebugSandbox', label: 'FX Debug Sandbox', group: 'Environment', paths: ['fxDebugSandbox'], muteMethods: ['update'] },
      { id: 'hitProxySystem', label: 'Hit Proxy System', group: 'Environment', paths: ['hitProxySystem'], muteMethods: ['update'] },
      { id: 'hitProxyAutoRegistrar', label: 'Hit Proxy Auto Registrar', group: 'Environment', paths: ['hitProxyAutoRegistrar'], muteMethods: ['update'] },
      { id: 'hitProxyRegistry', label: 'Hit Proxy Registry', group: 'Environment', paths: ['hitProxyRegistry'], muteMethods: ['update'] },
      { id: 'beadDebugUtils', label: 'Bead Debug Utils', group: 'Environment', paths: ['beadDebugUtils'], muteMethods: ['update'] },
      { id: 'fxPerformanceSmoothTransition', label: 'FX Performance Smooth Transition', group: 'Environment', paths: ['fxPerformanceSmoothTransition'], muteMethods: ['update'] },
      { id: 'safeWorldFXPack', label: 'Safe World FX Pack', group: 'Environment', paths: ['safeWorldFXPack'], muteMethods: ['update'] },
      { id: 'safeLegendaryWorldEvents', label: 'Safe Legendary World Events', group: 'Environment', paths: ['safeLegendaryWorldEvents'], muteMethods: ['update'] },
      { id: 'safeLegendaryLinkFX', label: 'Safe Legendary Link FX', group: 'Environment', paths: ['safeLegendaryLinkFX'], muteMethods: ['update'] },
      { id: 'safeNodePersonalityFX', label: 'Safe Node Personality FX', group: 'Environment', paths: ['safeNodePersonalityFX'], muteMethods: ['update'] },
      { id: 'safeEvolutionManager', label: 'Safe Evolution Manager', group: 'Environment', paths: ['safeEvolutionManager'], muteMethods: ['update'] },
      { id: 'safeAIWeatherPack', label: 'Safe AI Weather Pack', group: 'Environment', paths: ['safeAIWeatherPack'], muteMethods: ['update'] },
      { id: 'safeQuantumIllusionsPack', label: 'Safe Quantum Illusions Pack', group: 'Environment', paths: ['safeQuantumIllusionsPack'], muteMethods: ['update'] },
      { id: 'extremeAINodePack', label: 'Extreme AI Node Pack', group: 'Environment', paths: ['extremeAINodePack'], muteMethods: ['update'] },
      { id: 'extremeAIShaderPack', label: 'Extreme AI Shader Pack', group: 'Environment', paths: ['extremeAIShaderPack'], muteMethods: ['update'] },
      { id: 'linkExtensionConfig', label: 'Link Extension Config', group: 'Environment', paths: ['linkExtensionConfig'], muteMethods: ['update'] },
      { id: 'linkCategoryColorContract', label: 'Link Category Color Contract', group: 'Environment', paths: ['linkCategoryColorContract'], muteMethods: ['update'] },
      { id: 'linkTargetContract', label: 'Link Target Contract', group: 'Environment', paths: ['linkTargetContract'], muteMethods: ['update'] },
      { id: 'linkRenderLayerPolicy', label: 'Link Render Layer Policy', group: 'Environment', paths: ['linkRenderLayerPolicy'], muteMethods: ['update'] },
      { id: 'linkPointFXBase', label: 'Link Point FX Base', group: 'Environment', paths: ['linkPointFXBase'], muteMethods: ['update'] },
      { id: 'linkSurfacePhaseRipples', label: 'Link Surface Phase Ripples', group: 'Environment', paths: ['linkSurfacePhaseRipples'], muteMethods: ['update'] },
      { id: 'linkPulseDustEmitter', label: 'Link Pulse Dust Emitter', group: 'Environment', paths: ['linkPulseDustEmitter'], muteMethods: ['update'] },
      { id: 'linkPulseRing', label: 'Link Pulse Ring', group: 'Environment', paths: ['linkPulseRing'], muteMethods: ['update'] },
      { id: 'linkPulseWaveInjector', label: 'Link Pulse Wave Injector', group: 'Environment', paths: ['linkPulseWaveInjector'], muteMethods: ['update'] },
      { id: 'linkDirectionalStreaks', label: 'Link Directional Streaks', group: 'Environment', paths: ['linkDirectionalStreaks'], muteMethods: ['update'] },
      { id: 'linkRingArcDischarges', label: 'Link Ring Arc Discharges', group: 'Environment', paths: ['linkRingArcDischarges'], muteMethods: ['update'] },
      { id: 'linkHealingParticleSystem', label: 'Link Healing Particle System', group: 'Environment', paths: ['linkHealingParticleSystem'], muteMethods: ['update'] },
      { id: 'linkCorruptionParticleSystem', label: 'Link Corruption Particle System', group: 'Environment', paths: ['linkCorruptionParticleSystem'], muteMethods: ['update'] },
      { id: 'linkCorruptionTransmission', label: 'Link Corruption Transmission', group: 'Environment', paths: ['linkCorruptionTransmission'], muteMethods: ['update'] },
      { id: 'linkTrailParticleSystem', label: 'Link Trail Particle System', group: 'Environment', paths: ['linkTrailParticleSystem'], muteMethods: ['update'] },
      { id: 'linkBeadSystem', label: 'Link Bead System', group: 'Environment', paths: ['linkBeadSystem'], muteMethods: ['update'] },
      { id: 'linkBeadTrailSystem', label: 'Link Bead Trail System', group: 'Environment', paths: ['linkBeadTrailSystem'], muteMethods: ['update'] },
      { id: 'linkSparkSystem', label: 'Link Spark System', group: 'Environment', paths: ['linkSparkSystem'], muteMethods: ['update'] },
      { id: 'linkEnergyRingSystem', label: 'Link Energy Ring System', group: 'Environment', paths: ['linkEnergyRingSystem'], muteMethods: ['update'] },
      { id: 'linkQualityCalculator', label: 'Link Quality Calculator', group: 'Environment', paths: ['linkQualityCalculator'], muteMethods: ['update'] },
      { id: 'linkPriorityDecayEngine', label: 'Link Priority Decay Engine', group: 'Environment', paths: ['linkPriorityDecayEngine'], muteMethods: ['update'] },
      { id: 'linkPrioritySystem', label: 'Link Priority System', group: 'Environment', paths: ['linkPrioritySystem'], muteMethods: ['update'] },
      { id: 'linkCorrelationEngine', label: 'Link Correlation Engine', group: 'Environment', paths: ['linkCorrelationEngine1_0'], muteMethods: ['update'] },
      { id: 'linkStateVisualLanguage', label: 'Link State Visual Language', group: 'Environment', paths: ['linkStateVisualLanguage'], muteMethods: ['update'] },
      { id: 'linkVisualMoodSystem', label: 'Link Visual Mood System', group: 'Environment', paths: ['linkVisualMoodSystem'], muteMethods: ['update'] },
      { id: 'linkAutomationEngine', label: 'Link Automation Engine', group: 'Environment', paths: ['linkAutomationEngine1_0'], muteMethods: ['update'] },
      { id: 'linkRendererConduit', label: 'Link Renderer Conduit', group: 'Environment', paths: ['linkRendererConduit'], muteMethods: ['update'] },
      { id: 'linkSemanticPictogramSystem', label: 'Link Semantic Pictogram System', group: 'Environment', paths: ['linkSemanticPictogramSystem'], muteMethods: ['update'] },
      { id: 'linkResonanceFlowSystem', label: 'Link Resonance Flow System', group: 'Environment', paths: ['linkResonanceFlowSystem'], muteMethods: ['update'] },
      { id: 'linkCascadeInfectionSystem', label: 'Link Cascade Infection System', group: 'Environment', paths: ['linkCascadeInfectionSystem'], muteMethods: ['update'] },
      { id: 'linkCascadePulseManager', label: 'Link Cascade Pulse Manager', group: 'Environment', paths: ['linkCascadePulseManager'], muteMethods: ['update'] },
      { id: 'linkCollapseSystem', label: 'Link Collapse System', group: 'Environment', paths: ['linkCollapseSystem'], muteMethods: ['update'] },
      { id: 'linkCollapseEventFX', label: 'Link Collapse Event FX', group: 'Environment', paths: ['linkCollapseEventFX'], muteMethods: ['update'] },
      { id: 'linkDegradationSystem', label: 'Link Degradation System', group: 'Environment', paths: ['linkDegradationSystem'], muteMethods: ['update'] },
      { id: 'cascadeParticleSystem', label: 'Cascade Particle System', group: 'Environment', paths: ['cascadeParticleSystem'], muteMethods: ['update'] },
      { id: 'cascadeResonanceWaveVisualization', label: 'Cascade Resonance Wave', group: 'Environment', paths: ['cascadeResonanceWaveVisualization'], muteMethods: ['update'] },
      { id: 'resonanceCascadeVisualization', label: 'Resonance Cascade Visualization', group: 'Environment', paths: ['resonanceCascadeVisualization'], muteMethods: ['update'] },
      { id: 'resonanceEchoTrailSystem', label: 'Resonance Echo Trail System', group: 'Environment', paths: ['resonanceEchoTrailSystem'], muteMethods: ['update'] },
      ...
      { id: 'regionalHarmonicCycleController', label: 'Regional Harmonic Cycle Controller', group: 'Environment', paths: ['regionalHarmonicCycleController'], muteMethods: ['update'] },
      { id: 'nodeHarmonicManager', label: 'Node Harmonic Manager', group: 'Environment', paths: ['nodeHarmonicManager'], muteMethods: ['update'] },
      { id: 'harmonicSyncEffectApplier', label: 'Harmonic Sync Effect Applier', group: 'Environment', paths: ['harmonicSyncEffectApplier'], muteMethods: ['update'] },
      { id: 'standingWaveOscillationTrapSystem', label: 'Standing Wave Oscillation Trap System', group: 'Environment', paths: ['standingWaveOscillationTrapSystem'], muteMethods: ['update'] },
      { id: 'standingWaveVisualRenderer', label: 'Standing Wave Visual Renderer', group: 'Environment', paths: ['standingWaveVisualRenderer'], muteMethods: ['update'] },
      { id: 'waveInterferencePatternSystem', label: 'Wave Interference Pattern System', group: 'Environment', paths: ['waveInterferencePatternSystem'], muteMethods: ['update'] },
      { id: 'synergyTravelingWaveFX', label: 'Synergy Traveling Wave FX', group: 'Environment', paths: ['synergyTravelingWaveFX'], muteMethods: ['update'] },
      { id: 'waveShaderBridge', label: 'Wave Shader Bridge', group: 'Environment', paths: ['waveShaderBridge'], muteMethods: ['update'] },
      { id: 'waveShaderMaterialPatch', label: 'Wave Shader Material Patch', group: 'Environment', paths: ['waveShaderMaterialPatch'], muteMethods: ['update'] },
      { id: 'waveTravelShaderPack', label: 'Wave Travel Shader Pack', group: 'Environment', paths: ['waveTravelShaderPack'], muteMethods: ['update'] },
      { id: 'waveDynamicsShaderPack', label: 'Wave Dynamics Shader Pack', group: 'Environment', paths: ['waveDynamicsShaderPack'], muteMethods: ['update'] },
      { id: 'echoRippleSystem', label: 'Echo Ripple System', group: 'Environment', paths: ['echoRippleSystem'], muteMethods: ['update'] },
      { id: 'neuralConvergenceSingularity', label: 'Neural Convergence Singularity', group: 'Environment', paths: ['neuralConvergenceSingularity', 'neuralConvergence'], muteMethods: ['update', 'setEnabled', 'enable', 'disable'], hardDisabled: true }
    ];
  }
